...
var filename = 'dataset/0years_median_house_price.json';
var globalData = null;
...
var margin = {top: 20, right: 50, bottom: 30, left: 80},
    width = 295.4 - margin.left - margin.right,
...
var svg = d3.select("#svg2").append("svg").attr("class", "line-chart")
...
function hover() {
  ...
  function moved() {
    ...
    country.forEach(function(d){
      try{
        a = globalData[mouseXIndex][d][d];
      }
      catch{
        console.log(globalData)
        console.log(mouseXIndex,globalData[mouseXIndex])
        console.log(d,globalData[mouseXIndex][d])
        console.log(d,globalData[mouseXIndex][d][d])
      }
...
d3.json(filename).then(function(data) { 
  ...
  function mousemove() {
    var i = d3.bisect(timeScales, d3.pointer(this)[0]);
    var di = data[xaxis[i]];
    var countrytotal = [];
